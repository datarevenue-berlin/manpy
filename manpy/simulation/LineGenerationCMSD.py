    ...
    for i in range(len(resource)):
        ...
        if resourceClass == "Repairman":
            ...
            for j in range(len(property)):
                ...
                propertyName = (
                    propertyName[0].toxml().replace("<Name>", "").replace("</Name>", "")
                )
        ...
        if resourceClass == "Source":
            ...
            for j in range(len(property)):
                ...
                if propertyName == "partType":
                    ...
                    distributionParameter = distribution[0].getElementsByTagName(
                        "DistributionParameter"
                    )
                    distributionParameterName = distributionParameter[
                        0
                    ].getElementsByTagName("Name")
                    distributionParameterName = (
                        distributionParameterName[0]
                        .toxml()
                        .replace("<Name>", "")
                        .replace("</Name>", "")
                    )
                    ...
                    mean = float(
                        mean[0].toxml().replace("<Value>", "").replace("</Value>", "")
                    )
                ...
                if propertyName == "ProcessTime":
                    ...
                    for k in range(len(distributionParameter)):
                        ...
                        if distributionParameterName == "mean":
                            ...
                            stdev = distributionParameter[0].getElementsByTagName(
                                "Value"
                            )
                            stdev = float(
                                stdev[0]
                    ...
                    for k in range(len(distributionParameter)):
                        ...
                        if distributionParameterName == "mean":
                            MTTF = distributionParameter[0].getElementsByTagName(
                                "Value"
                            )
                            MTTF = float(
                                MTTF[0]
                    ...
                    for k in range(len(distributionParameter)):
                        ...
                        if distributionParameterName == "mean":
                            MTTR = distributionParameter[0].getElementsByTagName(
                                "Value"
                            )
                            MTTR = float(
                                MTTR[0]
    ...
    for i in range(len(process)):
        ...
        if processIdentifierValue == "MainProcessSequence":
            ...
            for j in range(len(processNode)):
                processNodeIdentifier = processNode[j].getElementsByTagName(
                    "ProcessIdentifier"
                )
                processNodeIdentifier = (
                    processNodeIdentifier[0]
                    .toxml()
                    .replace("<ProcessIdentifier>", "")
                    .replace("</ProcessIdentifier>", "")
                )
...
def readProcesses():
    ...
    for i in range(len(process)):
        ...
        if processIdentifierValue in G.processIdentifiers:
            ...
            G.TopologyList[
                G.processIdentifiers.index(processIdentifierValue)
            ] = resourceIdentifier
...
def main():
    ...
    topologyId = eval(input("give the path to the CMSD file\n"))
    try:
    ...
    for i in range(G.numberOfReplications):
        ...
        if G.trace == "Yes":
            ...
            G.traceSheet = G.traceFile.add_sheet(
                "sheet " + str(G.sheetIndex), cell_overwrite_ok=True
            )  # create excel sheet
