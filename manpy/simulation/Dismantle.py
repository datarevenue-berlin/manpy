...
class Dismantle(CoreObject):
    ...
    def initialize(self):
        ...
        self.waitToDisposePart = (
            False  # flag that shows if the object waits to dispose a part
        )
        self.waitToDisposeFrame = (
            False  # flag that shows if the object waits to dispose a frame
        )
        ...
        while 1:
            ...
            if self.isRequested.value:
                ...
                while not self.isEmpty():
                    ...
                    if self.isEmpty():
                        self.waitToDisposeFrame = (
                            False  # the Dismantle has no Frame to dispose now
                        )
                        break
    ...
    def removeEntity(self, entity=None):
        ...
        activeEntity = CoreObject.removeEntity(
            self, entity, resetFlags=False, addBlockage=False
        )
        # update the flags
