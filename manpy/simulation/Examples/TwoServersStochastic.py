...
R = Repairman("R1", "Bob")
S = Source("S1", "Source", interarrivalTime={"Exp": {"mean": 0.5}}, entity="manpy.Part")
M1 = Machine(
    "M1",
    "Machine1",
    processingTime={"Normal": {"mean": 0.25, "stdev": 0.1, "min": 0.1, "max": 1}},
)
M2 = Machine(
    "M2",
    "Machine2",
    processingTime={"Normal": {"mean": 1.5, "stdev": 0.3, "min": 0.5, "max": 5}},
)
Q = Queue("Q1", "Queue")
E = Exit("E1", "Exit")
# create failures
